...
secinft = Seccion('Elementos', TipoSeccion.GENERAL, [
                  9 * 10 ** 10, 9 * 10 ** -10], concreto)
...
estructura.agregarElemento(nodoInicial=1, nodoFinal=0,
                           seccion=seccion, defCortante=False, tipo=Tipo.CUATRO)
estructura.agregarElemento(nodoInicial=2, nodoFinal=0,
                           seccion=seccion, defCortante=False, tipo=Tipo.CUATRO)
estructura.agregarElemento(nodoInicial=4, nodoFinal=3,
                           seccion=seccion, defCortante=False, tipo=Tipo.CUATRO)
estructura.agregarElemento(nodoInicial=5, nodoFinal=3,
                           seccion=seccion, defCortante=False, tipo=Tipo.CUATRO)
estructura.agregarElemento(nodoInicial=0, nodoFinal=3,
                           seccion=secinft, defCortante=False, tipo=Tipo.UNO)
...
print(estructura.solucionar(verbose=True, dibujar=True,
      guardar=False, carpeta='', analisis='CR', param=param))
